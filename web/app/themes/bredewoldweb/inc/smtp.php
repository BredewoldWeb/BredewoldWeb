...
if (WP_ENV == 'development') {
    add_action("phpmailer_init", function ($phpmailer) {
        ...
        $phpmailer->Username = 'gerritjan@bredewold.nl';
        $phpmailer->Password = 'qZ8cjxtXWFrkUYah';
    });
}
...
add_filter("wp_mail", function($atts){
    ...
    $atts["message"] = str_replace('<p>', '<p style="margin-top:0px; margin-bottom:0px; min-height:24px; line-height:24px;">', $atts['message']);
    $atts["message"] = str_replace('<ul', '<ul style="margin-top:0px; margin-bottom:0px; padding-left:0px;" ', $atts['message']);
    $atts["message"] = str_replace('<li', '<li style="margin-left:20px" ', $atts['message']);
...
?>
 ...
 <![endif]-->
    ...
    <body width="100%" bgcolor="#fff" style="margin: 0px; mso-line-height-rule: exactly; padding:0px;">
        <center style="margin: 0px; padding: 0px; width: 100%; max-width:100%; background: #fff; text-align: left;">
 ...
 -->
    ...
    <![endif]-->
                ...
                <!-- Email Header : BEGIN -->
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="100%" style="max-width: 680px; font-family: sans-serif; color: #444444; font-size: 12px; line-height: 140%;">
                    <tr>
                        <td class="top-spacer" style="padding: 18px 10px; width: 100%; color: #888888;">
                        </td>
                    </tr>
                </table>
                <!-- Email Header : END -->
                ...
                <!-- Email Body : BEGIN -->
                <table role="presentation" cellspacing="0" cellpadding="0" border="0" align="center" width="680px" style="max-width: 100%;">

                    <!-- Hero Image, Flush : BEGIN -->
                    <tr>
                        <td class="padded" bgcolor="#fff" style="padding: 18px 0px 18px 0px; border-bottom: 0px solid #ff001c; background-color: #fff;">
                            <table role="header-table" id="header-table" cellspacing="0" cellpadding="0" border="0" align="center" width="100%">
                                <tr>
                                    <td>
                                        <a href="<?= home_url(); ?>">
                                            <img src="<?= home_url(); ?>/app/themes/bredewoldweb/img/email-logo.png" width="210" height="" border="0" align="center" style="width: 210px; max-width: 100%; height: auto; background: #fff;" class="g-img">
                                        </a>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <tr>
                        <td bgcolor="#ffffff">
                            <table role="presentation" cellspacing="0" cellpadding="0" border="0" width="680px" style="max-width: 100%;">
                                <tr>
                                    <td class="content-cell padded" style="padding: 36px 0px; font-size: 18px; color: #000000;">
                                        [content]
                                    </td>
                                </tr>
                            </table>
...
/* Change default allfields merge tag styling */
/**
